...
const generateAccessAndRefreshTokens = async (userId) => {
  try {
    ...
    await user.save({ validateBeforeSave: false }); // validateBeforeSave : false to skip validation of refreshToken field
...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  const getWatchHistory = asyncHandler(async (req, res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, user[0].watchHistoryVideos, "Watch history retrieved successfully"));
  })
